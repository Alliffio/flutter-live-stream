...
class VideoProvider with ChangeNotifier {
  ...
  Future<void> getVideo(String requestKeyword) async {
    final keyword = 'lofi' + requestKeyword; //DIMANA KEYWORDNYA MENGGUNAKAN PREFIX USTADZ SEHINGGA HANYA AKAN MENGAMBIL DATA YANG TERKAIT DENGAN USTADZ
    final apiToken = 'AIzaSyC90jgKHMtgJDz8Q2eZ132D_mnMj0Eq15c'; //MASUKKAN API TOKEN YANG KAMU DAPATKAN DARI PROSES SEBELUMNYA
